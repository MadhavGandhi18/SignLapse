...
export default function Home() {
  ...
  const isSignStudioVisible = useInView(signStudioRef, { once: false, margin: "-100px", amount: 0.1 })
  const isMissionVisible = useInView(missionRef, { once: false, margin: "-100px", amount: 0.1 })
  const isTransportVisible = useInView(transportRef, { once: false, margin: "-100px", amount: 0.1 })
  const isAccessibilityVisible = useInView(accessibilityRef, { once: false, margin: "-100px", amount: 0.1 })
  const isCtaVisible = useInView(ctaRef, { once: false, margin: "-100px", amount: 0.1 })
  ...
  // Add useEffect to set up a global accessor for the scrollToSection function
  useEffect(() => {
    // @ts-ignore - adding the function to the window object for global access
      ...
      >
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            {/* Right Side Cards */}
            <div className="lg:col-span-5 grid grid-rows-[auto_auto] gap-8">
              {/* Video Card - Make it taller to avoid cropping */}
              <div className="relative aspect-[16/10] bg-gray-800 rounded-3xl overflow-hidden">
                <video 
                  src="/images/si.mp4"
              ...
              {/* Stats Cards - Equal height squares */}
              <div className="grid grid-cols-2 gap-8 h-full">
                {/* BSL Announcements Card */}
                <div className="bg-[#ECFDF5] rounded-3xl p-6 flex flex-col justify-between aspect-square">
                  ...
                  <p className="text-[#059669] text-sm mt-auto">
                    ISL train announcements generated daily throughout India
                  </p>
                </div>

                {/* Deaf People Stats Card */}
                <div className="bg-[#A78BFA]/20 rounded-3xl p-6 flex flex-col justify-between aspect-square">
                  <p className="text-gray-600 text-sm">
                    Profoundly Deaf people worldwide
                  </p>
                  <h4 className="text-6xl font-bold text-gray-900 mt-auto">
                    430m
                  </h4>
                </div>
              </div>
      ...
      >
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            {/* Left side - Image */}
            <div className="lg:col-span-5 relative lg:ml-auto">
              <div className="relative bg-gray-800 rounded-3xl aspect-[4/3] overflow-hidden max-w-2xl mx-auto">
                <Image
                  src="/images/sign.jpg"
            ...
            {/* Right side - Content */}
            <div className="lg:col-span-7 text-white lg:pl-8">
